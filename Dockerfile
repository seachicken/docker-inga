...
RUN set -eux; \
  curl -o ./inga.tar.gz \
    -L https://github.com/seachicken/inga/archive/refs/tags/v0.1.1-pre.tar.gz; \
  mkdir inga; \
...
RUN set -eux; \
  curl -o ./tsparser.tar.gz \
    -L https://github.com/seachicken/tsparser/archive/refs/tags/v0.0.2.tar.gz; \ mkdir tsparser; \
